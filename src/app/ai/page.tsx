...
type ToneProfile = { id: string; name: string; instructions: string; is_default?: boolean; [key: string]: unknown };

export default async function AIPage() {
  const [tones, settings] = await Promise.all([listToneProfiles(), getAiSettings()]);
  const toneProfiles = tones as ToneProfile[];
  return <AppShell>
